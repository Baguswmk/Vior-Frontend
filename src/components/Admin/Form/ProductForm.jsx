      ...
      <div className=" bg-white  rounded-[4px] p-3">
        ...
        <div>
          ...
          <div className="w-full flex items-center flex-wrap">
            <label htmlFor="uploadImages"> {/* Menggunakan htmlFor dengan id yang sesuai */}
        ...
        <div>
          ...
          />
          <div className="w-full flex items-center flex-wrap">
            <label htmlFor="uploadModels"> {/* Menggunakan htmlFor dengan id yang sesuai */}
              <AiOutlinePlusCircle size={30} className="mt-3" color="#555" />
            </label>
            {models.map((model, index) => (
              <div key={index} className="relative m-2">
                <button
                  className="absolute z-10 top-0 right-0 p-1 bg-red-500 rounded-full"
