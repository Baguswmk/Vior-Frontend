    ...
    <div className="w-full h-[90vh] bg-white shadow-sm overflow-y-scroll sticky top-2 left-0 z-10">
      ...
      <div className="w-full flex items-center p-4">
        <Link to="/dashboard-create-product" className="w-full flex items-center">
          <AiOutlineFolderAdd size={30} color={`${active === 5 ? "crimson" : "#555"}`} />
          <h5 className={`hidden 800px:block pl-2 text-[18px] font-[400] ${active === 5 ? "text-[crimson]" : "text-[#555]"}`}>Create Product</h5>
        </Link>
      </div>
