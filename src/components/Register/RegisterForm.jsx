...
const RegisterForm = ({ role, handleBack }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                className="group relative w-full h-[40px] flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white  bg-[#323334] hover:ring-[#323334] hover:ring-1 hover:bg-white hover:text-black transition-all  ease-in-out"
              >
                Submit
              </button>
            </div>
        ...
        <Link onClick={handleBack} className="mt-6 flex items-center py-3 px-4  text-black hover:font-bold transition-all ease-in-out">
          <IoIosArrowBack />
