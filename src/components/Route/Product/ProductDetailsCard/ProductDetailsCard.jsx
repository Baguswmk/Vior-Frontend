          ...
          <div className="w-[90%] 800px:w-[60%] h-[90vh] overflow-y-scroll 800px:h-[75vh] bg-white rounded-md shadow-sm relative p-4">
            ...
            <div className="block w-full 800px:flex">
              <div className="w-full 800px:w-[50%]">
                <img loading="lazy" src={`${data.images && data.images[0].url}`} alt="" />
                <div className="flex mt-4 ">
                  <Link to={`/desainer/preview/${data._id}`} className="flex">
                    <img loading="lazy" src={`${data.images && data.images[0].url}`} alt="" className="w-[50px] h-[50px] rounded-full mr-2" />
                    <div>
                      <h3 className={`${styles.shop_name}`}>{data.creator.name}</h3>
              ...
              <div className="w-full 800px:w-[50%] pt-5 pl-[5px] pr-[5px]">
                ...
                <div className="flex pt-3">
                  <h4 className={`${styles.price}`}>{formatPrice(data.price)}</h4>
                </div>
                <div className="flex items-center mt-12 justify-between pr-3">
                  ...
                  <div>
                    {click ? (
                      ...
                      <AiOutlineHeart size={30} className="cursor-pointer" onClick={() => addToWishlistHandler(data)} title="Add to wishlist" />
                    )}
                  </div>
                </div>
