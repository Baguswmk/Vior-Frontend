        ...
        {cart && cart.length === 0 ? (
          ...
          <>
            <div>
              ...
              {/* cart Single Items */}
              <br />
              <div className="w-full border-t">{cart && cart.map((i, index) => <CartSingle key={index} data={i} quantityChangeHandler={quantityChangeHandler} removeFromCartHandler={removeFromCartHandler} />)}</div>
            </div>
            ...
            <div className="px-5 mb-3">
              ...
              <Link to="/checkout">
                <div className={`h-[45px] flex items-center justify-center w-[100%] bg-[#e44343] rounded-[5px]`}>
                  <h1 className="text-[#fff] text-[18px] font-[600]">Checkout Now ({formatPrice(totalPrice)})</h1>
                </div>
              </Link>
            </div>
          </>
    ...
    <div className="border-b p-4">
      <div className="w-full flex items-center">
        ...
        <div className="pl-[5px]">
          ...
          <h4 className="font-[600] text-[17px] pt-[3px] text-[#d02222] font-Roboto"> {formatPrice(totalPrice)}</h4>
        </div>
