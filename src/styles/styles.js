const styles = {
  ...
  // productDiscountPrice: "font-[500] text-[14px] text-[#d55b45] pl-3 mt-[-4px] line-through",
  shop_name: "pt-3 text-[15px] text-blue-400 pb-3",
  active_indicator: "absolute bottom-[-27%] left-0 h-[3px] w-full bg-[crimson]",
  button: "flex justify-center py-3 px-6 border border-transparent text-sm font-medium rounded-md text-white bg-[#323334] hover:ring-[#323334] hover:ring-1 hover:bg-white hover:text-[#333] transition-all ease-in-out",
